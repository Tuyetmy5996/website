...
Class User extends MY_Controller
{
    ...
    function login()
    {
        ...
        //     if ($user->id!=24)//Neu nguoi khac thi id se khac, nen chi co 1 id duy nhat thoi, khong tin H thu lay tai khaon khac coi
        //         redirect(site_url('user'));
        //     else
        //         redirect(site_url('admin/login'));
        //     //Go to user page, quan trong la cho nay ne, heo ko biet cach dan link cua tui nay
        // }
        ...
        if($this->input->post())
        {
            ...
            if($this->form_validation->run())
            {
                ...
                $this->session->set_flashdata('message', $user->name);
                if ($user->id!=24)
                    redirect(site_url('user'));
                else
                    redirect(site_url('admin/login'));
