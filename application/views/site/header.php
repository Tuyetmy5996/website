...
<div class="top">
      ...
      <div id="logo"><!-- the logo -->
           <a title="Những thương hiệu đẳng cấp" href="<?php echo base_url()?>">
	           <img alt="Những thương hiệu đẳng cấp" src="<?php echo public_url()?>/site/images/logo.png" style="width:250px">
	       </a>
       </div>
       <!-- End logo -->
